...
function loadDefinitions(){
    ...
    canvas = document.getElementById("specsCanvas");
    goButton = document.getElementById("gobutton");
    slideSound = createjs.Sound.registerSound({id:"soundId", src:"sounds/slidesound.mp3"});
    snellen = "'img/snellen.png') }}"
    blockedspecs = "img/optometry_specs_blocked.png";
    plusLens = "img/plus-lens.png";
    minusLens = "img/minus-lens.png";
...
function init() {
    ...
    myMinusLens.src = "{{ url_for ('static', filename = 'img/minus-lens.png') }}";
    var myPlusLens = new Image();
    myPlusLens.src = "{{ url_for ('static', filename = 'img/plus-lens.png') }}";
...
function go(){
  ...
  //  bootbox.alert("The clock will start when you place your first lens. Good Luck!", console.log("done"));
...
function updateTheScores(lensesTotals){
    ...
    updateLabel.innerHTML=" {{ current_user.first_name }} "+ "has lenses which combine to "+ lensesTotals +" diopters." + " The patient's prescription is " + myPrescription + " ds.";
...
function showTheDialog(finalscore){
    ...
    bootbox.dialog({
        ...
        title: "Well done, " + '{{ current_user.first_name }}',
        buttons:{
            success: {
                label: "Save Score",
